...
#define SET_VELOCITY                0xA2 //Mod for RMD_10_V3
...
#define x10_V3_KT             0.32f     //TO REVIEW
#define CURRENT_RAW_MIN       -2000
#define CURRENT_RAW_MAX       2000
#define VELOCITY_MIN          -1020      //dps SPEED
#define VELOCITY_MAX          1020
...
const RmdMotor::MotorType RmdMotor::RMD_X10_V3{REDUCTION_7_TO_1, x10_V3_KT, NEGATIVE};
...
{
    can_frame can_msg;
    int32_t velocity_uint = constrain(((int32_t)(velocity_setpoint)), VELOCITY_MIN, VELOCITY_MAX);
    
    can_msg.can_id  = 0x141;
    can_msg.can_dlc = 0x08;
    can_msg.data[0] = SET_VELOCITY;
    can_msg.data[1] = 0x00;
    can_msg.data[2] = 0x00;
    can_msg.data[3] = 0x00;
    can_msg.data[4] = static_cast<uint8_t>(velocity_uint);
    can_msg.data[5] = static_cast<uint8_t>(velocity_uint >> 8);
    can_msg.data[6] = static_cast<uint8_t>(velocity_uint >> 16);
    can_msg.data[7] = static_cast<uint8_t>(velocity_uint >> 24);
